...
public class TowersOfHanoiJackAlbrecht {
    public static void main(String[] args) {
        //Explanation of the game.(extra credit)
        ...
        //extra space for design purposes(extra credit)
        System.out.println("");
        //Taunting for Extra Credit lol(extra credit)
        System.out.println("Try to beat me if you can! Are you ready?");
        //Scanner to allow users to quit the game or continue.(extra credit)
        Scanner myNum = new Scanner(System.in);
        //extra space for design purposes(extra credit)
        System.out.println("");
        System.out.print("Enter 'y' to continue or 'n' to close the program: ");
        String input = myNum.nextLine();
        /*/This setup will also make the program quit only after completing
        the desired tasks.(extra credit)/*/
